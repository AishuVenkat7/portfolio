...
import "./about.css";
import AboutImg from "../../assets/girl_coder_ai_4.png";
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          <Fade right duration={2000}>
            ...
            {/* <a href={Resume} className="button button--flex">Download Resume</a> */}
            <a
              className="button button--flex"
              href="https://drive.google.com/file/d/1wLonOdswqjZEW5OYkdusRG58tw8V3TtU/view?usp=sharing"
              target="_blank"
            >
              See My Resume
              <svg
